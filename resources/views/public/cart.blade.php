            ...
            <div class="card-body">
                ...
                @if(Cart::content()->count())
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="4"><a href="{{route('all')}}" class="text-primary">Continue shopping</a></td>
                ...
                @else
                    <div class="alert alert-warning">No item found in cart. <a href="{{route('all')}}"> Continue shopping</a></div>
                @endif
            </div>
        </div>
    </div>
