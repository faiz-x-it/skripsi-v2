<div class="comments-section">
    <div class="card card-body my-4" id="review-section">
        <div class="comments-area">
            <h4 class="text-center mb-2"><i class="fas fa-comments"></i> {{$produk_reviews->count()}} {{str_plural('Review', $produk_reviews->count()) }}</h4>
            @foreach($produk_reviews as $review)
            <div class="single-comment my-2">
                <div class="card card-body bg-light">
                    <div class="author-info mb-2 d-flex flex-row">
                        <div class="comment-user-img mr-3">
                            <img src="{{$review->user->image? $review->user->image_url : $produk->default_img}}" alt="" width="60">
                        </div>
                        <div>
    ...
    <div class="card card-body my-4">
        @if(Auth::check())
            <div class="comment-form">
                ...
                <form action="{{route('book.review', $produk->id)}}" method="post">
                    @csrf
