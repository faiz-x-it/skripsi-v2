...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark p-1 border-bottom" id="nav-top">
    <div class="container">
        <a href="{{route('shop.home')}}" class="logo-img"><img src="{{asset('/')}}assets/img/logo.png" alt=""></a>
        ...
        <div class="collapse navbar-collapse" id="nav-collapse">
            <ul class="navbar-nav">
                ...
                <li class="nav-item px-2">
                    <a href="{{route('all')}}" class="nav-link">Books</a>
                </li>
                <li class="nav-item px-2">
                    <a href="{{route('discount')}}" class="nav-link">Discount's Books</a>
                </li>
                <li class="nav-item px-2">
...
<section class="header py-2 bg-light">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div class="headings">
                    <h3><a href="{{route('shop.home')}}" class="text-secondary"><b class="text-danger">Book</b> Shop</a></h3>
                </div>
            </div>
            <div class="col-md-4">
